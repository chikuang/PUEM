...
library(ggpubr)
set.seed(777)
dat_SCAR <- sim_data(n=500, m=500, piVal=0.3, mu1=rep(0,2), mu2= rep(0,2), mu3=rep(0,2))
...
res3 <- elpu3(dat_SAR, param)
res3_fix_pi <- elpu3(dat_SAR, param, updatePiVal = FALSE)
reJ_ind <- 2*(res3$llk - res3_fix_pi$llk) < qchisq(0.95, 1)
(ind_cover_pi <- ifelse(reJ_ind == "1", "Cover", "Not Cover"))

res2 <- elpu2(dat_SAR, param)
